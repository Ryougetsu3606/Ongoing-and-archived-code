...
stft = ConvSTFT(win_len=320, win_inc=160, fft_len=512, feature_type="real")
...
class DCCRN(nn.Module):
    ...
    def forward(self, inputs, lens=None):
        ...
        return out_spec,  out_wav, latent_out
...
if __name__ == '__main__':
    ...
    inputs = torch.randn([10,16000*8]).clamp_(-1,1)
    labels = torch.randn([10,16000*8]).clamp_(-1,1)
